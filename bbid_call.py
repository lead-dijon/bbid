...
INPUT  = "/home/expe/public_html/bbid/py/res/"
OUTPUT = "/home/expe/public_html/bbid/wk/"
LOGS   = "/home/expe/public_html/bbid/logs/generation.txt"
HOST    = "i3m-lead-0243.u-bourgogne.fr"
SMTP    = "25"
ADDRESS = "BBID <bbid@" + HOST + ">"
MESSAGE = "From: " + ADDRESS + "\n" \
		  "To: {}\n" \
		  "Subject: Request #{} available\n" \
		  "Dear user\n\n" \
		  "Your request #{} has been completed in about {} s.\n\n" \
		  "You may download it at https://i3m-lead-0243.u-bourgogne.fr/~expe/bbid/web/results.html" + "\n\n" \
		  "Best regards\n\n" \
		  "The BBID Team\n"
...
argumentParser.add_argument("-id" , "--identifier"                  , type = str  , help = "Identifier"      , default = 0)
...
argumentParser.add_argument("-@"  , "--address"                    , type = str  , help = "Address"         , default = "")
arguments = argumentParser.parse_args()


if arguments.identifier != 0 :
	output = os.path.join(OUTPUT, arguments.identifier)
	os.mkdir(output)
else :
	output = OUTPUT
...
result = arguments.identifier + ".txt"
...
if arguments.address != "" :
	smtp = smtplib.SMTP(HOST, SMTP)
	smtp.sendmail(ADDRESS, arguments.address, MESSAGE.format(arguments.address, arguments.identifier, arguments.identifier, duration))
	smtp.quit()
